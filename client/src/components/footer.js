  ...
  return (
    <div id="footer" className="bg-secondary px-4 text-light">
			<div className="row container-md mx-auto">
				<div className='d-flec flex-column col-12 col-md-5 pe-0 pe-md-5'>
					<img src="/assets/logo-white.png" width="140" height="40" className="d-block align-top mb-3" alt="Afriscope Logo"
					/>
					<span style={{textAlign: "left"}} className="d-block mb-3">
				...
				<div className ="col-12 col-md-4">
					...
					<span>Subscribe to our newsletter. Be always in trend!</span>
